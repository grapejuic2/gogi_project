...
public abstract class BaseController {
	private static final String CURR_IMAGE_REPO_PATH = "C:\\gogi\\file_repo";
	private static final String CURR_IMAGE_REPO_PATH1 = "C:\\gogi\\file_repo\\notice";
	 ...
	 * File(CURR_IMAGE_REPO_PATH+"\\"+fileName); try{ file.delete();
