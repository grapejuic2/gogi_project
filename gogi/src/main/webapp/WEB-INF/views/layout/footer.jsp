...
<body>
	...
	<div class="container">
		<div class="leftInfo">
			...
			<br>
			<p>
				(주)육룰 | 주소: 서울 성동구 마장로33길 53<br> 개인정보관리책임자:
				오동림(privacy@meatrule.com)
			</p>
			...
			<span><a href="${contextPath}/admin/notice/listNotice.do"
				class="text-reset">공지사항 | </a></span> <span><a
				href="${contextPath}/board/qna/listQna.do" class="text-reset">고객센터</a></span>


			<h6 class="text-uppercase fw-bold mb-4">
				<p>Copyright 2023. 육룰 All rights reserved.
			</h6>
		</div>
