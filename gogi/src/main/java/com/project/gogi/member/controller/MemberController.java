...
public interface MemberController {
	...
	//이메일 인증
	//public ResponseEntity<Map<String, String>> mailConfirm(@RequestParam("mem_email")String email, HttpServletRequest request, HttpServletResponse response) throws Exception;
