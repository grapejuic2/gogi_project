package com.project.gogi.review.controller;
...
import com.project.gogi.review.service.ReviewService;
...
public class ReviewControllerImpl implements ReviewController {
	...
	@Autowired
	private ReviewService boardReviewService;
	...
	private ModelAndView form(@RequestParam(value = "goods_id", required = false) String goods_id,
		...
		String viewName = (String) request.getAttribute("viewName");
		if (viewName.equals("/review/reviewForm")) {
			HttpSession session = request.getSession();
			if (goods_id != null) {
