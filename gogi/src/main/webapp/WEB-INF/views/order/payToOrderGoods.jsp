		...
		<TBODY align=center>
			...
			<TR>
				<c:forEach var="item" items="${myOrderList }">
					...
					<td><h2>${item.order_quantity *item.goods_sales_price}원 (10% 할인)</h2></td>
					<td><h2>0원</h2></td>
					<td><h2>${1500 *item.order_quantity }원</h2></td>
					<td>
					  <h2>${item.order_quantity *item.goods_sales_price}원</h2>
					</td>
			</TR>
			</c:forEach>
		</TBODY>
