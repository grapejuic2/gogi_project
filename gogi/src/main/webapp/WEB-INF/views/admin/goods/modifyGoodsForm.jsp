      ...
      <DIV class="frm_mod_tab" id="tab1">
         <table class="table">
            <tr>
               ...
               <td width=15% ><input type="button" value="수정반영"
            ...
            <tr>
               <td>상품소개</td>
               <td><textarea rows="8" cols="70" name="goods_intro">
                  ${goods.goods_intro }
                  </textarea></td>
               <td>&nbsp;&nbsp;&nbsp;&nbsp; 
                  ...
                  <c:forEach var="item" items="${imageFileList }"
                     ...
                     <c:choose>
                        <c:when test="${item.file_type=='main_image' }">
                           <tr>
                              <td width="20%">메인 이미지</td>
                              <td width="20%"><input type="file" id="main_image" name="main_image"
                                 onchange="readURL(this,'preview${itemNum.count}');" /> <input
                                 type="hidden" name="image_id" value="${item.image_id}" /> <br>
                              </td>
                              <td width="20%"><img id="preview${itemNum.count }" width=200
                                 height=200
                                 src="${contextPath}/thumbnails.do?goods_id=${item.goods_id}&fileName=${item.file_name}" />
                              </td>
                              <td width="20%"><input type="button" value="수정"
