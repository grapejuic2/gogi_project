				...
				<div class="row row1">
					<table class="table">
						<tr>
							...
							<input style="width: 350px;" type="text" name="mem_id" value="${noticeRead.mem_id}" /></td>
						...
						<tr>
							<td colspan="4" class="text-left fg" valign="top" height="200">
								...
								<textarea cols="100" rows="12" name="notice_content">${noticeRead.notice_content}</textarea>
								</pre>
							</td>
						</tr>
						<tr>
