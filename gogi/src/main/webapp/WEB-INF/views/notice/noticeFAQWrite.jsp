				...
				<table class="table">
					<tr>
						...
						<td width=35% class="text-left fgl">
				 							<input style="width: 350px;" type="text" name="mem_id"  placeholder="이름을 입력해 주세요"  />
					...
					<tr>
						...
						type="text" name="notice_title_faq" placeholder="제목을 입력해 주세요" />
						 </td>
					</tr>
					<tr>
						<td colspan="4" class="text-left fg" valign="top" height="200">
							<pre class="fgl"
								style="white-space: pre-wrap; border: none; background-color: white;">
									<textarea cols="100" rows="12"  name="notice_content_faq" placeholder="내용을 입력해 주세요" ></textarea>
								</pre>
						</td>
					</tr>
					<tr>
