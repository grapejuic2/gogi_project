...
<body>
   <h1> 게시물 수정 </h1>
      <form method="post"  name="form"  id="updateForm" role="form" enctype="multipart/form-data" action="${contextPath}/serv/modify.do">
         <div role="main" class="container" style="padding-bottom: 100px">
               ...
               <table class="table">
                  ...
                  <th width="15%" class="text-center lb fg fw" style="vertical-align: middle;">문의내역</th>
                     <td colspan="4" class="text-left fg" valign="top" height="200">                     
                        ...
                        <textarea cols="80" rows="8" name="serv_content"
                           class="bordered-input"
                           style="width: 100%; height: 100%; padding: 0; margin: 0;">${servRead.cust_serv_content}</textarea>
                        </pre>
                     </td>
                  </tr>
            ...
            <c:if test="${not empty imageFileList && imageFileList!='null' }">
               <c:forEach var="item" items="${imageFileList}">
                  ...
                  <tr>
                     <td>
                        <input type="file" name="imageFileName" disabled oncange="readURL(this);"><!-- 수정된 이미지 파일 이름을 전송합니다. -->
                     </td>
                  </tr>
